  ...
  return (
    <div>
      ...
      <div className="grid-3">
        <div className="card stat-card">Ingresos: <strong>Q{Number(balance.ingresos || 0).toFixed(2)}</strong></div>
        <div className="card stat-card">Egresos: <strong>Q{Number(balance.egresos || 0).toFixed(2)}</strong></div>
        <div className="card stat-card">Balance: <strong>Q{Number(balance.balance || 0).toFixed(2)}</strong></div>
      </div>
